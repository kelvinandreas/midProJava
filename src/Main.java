...
public class Main {
	...
	Vector<Pegawai> pegawae = new Vector<Pegawai>();
	public Main(){
		int pilihan;
		do {
	...
	public void viewData() {
		 int nomor = 1;
		    ...
		    Collections.sort(pegawae, new Comparator<Pegawai>() {
		        @Override
	...
	public void deleteData() {
		...
		do {
			...
			pilihan = scan.nextInt();
		}while(pilihan < 1 || pilihan > pegawae.size());
	...
	public void updateData() {
		...
		do {
			...
			pilihan = scan.nextInt();
		}while(pilihan < 0 || pilihan > pegawae.size());	
